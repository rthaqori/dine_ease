...
interface MenuItemAdminClientProps {
  id: string;
}

export default function MenuItemAdminClient({ id }: MenuItemAdminClientProps) {
  ...
  async function onSubmit(values: FormValues) {
    try {
      await updateMutation.mutateAsync({ id, data: values }).then(() => {
        setIsEditing(false);
